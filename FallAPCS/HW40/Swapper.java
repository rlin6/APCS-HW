...
V2: I edited my initialization of the array so that it creates a new w x w array where w is a number between 2 and 10. This will generate an array of random length. Iadded extra lines between my printing of arrays and other sentences so that the layout will look more pleasing. I created a new results method that will tell you which two words got swapped so that you do not have to manually look through the whole array  */
...
public class Swapper
{
  ...
  public Swapper (int num)
  { //overloaded takes dimensions
    this();
    a = populate(num, num);
  }
  ...
  public void results(int r1, int r2, int c1, int c2)
  {
    String l1 = "" + (r1 + 1);
    String l2 = "" + (c1 + 1);
    String l3 = "" + (r2 + 1);
    String l4 = "" + (c2 + 1);
    System.out.println("\nResults: " + a[r2][c2] + " at " + l1 + " " + l2 + " was swapped with " + a[r1][c1] + " at " + l3 + " " + l4 + "\n");
  }

  public static void main(String[] args) {
    int r1,r2,c1,c2;  //init placekeepers
    Swapper arr = new Swapper((int)((Math.random() * 8) + 2));  //creates up to 10 x 10 array
    ...
    for (;;) {
      ...
      arr.results(r1,r2,c1,c2);  //print which swapped with which
