...
;Arrested means caught By? a cop
;Jail means in jail
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;Capture The Flag;;;;;;;;;;;Not Functional Right Now
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;to FlagBehavior
  ;if [ pcolor ] of patch-here = green [
    ;ask defenders [
     ;die ] ]
  ;ifelse captured? = false [
    ;let x ( [ pxcor ] of one-of patches with [ pcolor = yellow ] )
    ;let y ( [ pycor ] of one-of patches with [ pcolor = yellow ] )
    ;setxy x y ] [
    ;face one-of Attackers with [ flag? = true ]
    ;fd speed-of-runners ]
;end

;to flaghunt
  ;ifelse any? flags in-radius radius-of-Runners with [ captured? = false ] [
      ;face one-of flags in-radius radius-of-Runners with [ captured? = false ]
      ;fd speed-of-Runners
      ;if any? flags-here with [ captured? = false ] [
        ;ask flags-here [
          ;set captured? true ]
        ;set flag? true ] ] [
      ;wiggle speed-of-runners ]
