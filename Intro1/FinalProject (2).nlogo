...
to chase
  ...
  ifelse any? NotIts with [ tagged? = false ] in-radius radius-of-taggers [
     face min-one-of NotIts with [ tagged? = false ] [ distance myself ]
     fd speed-of-taggers
     rt 181 ]
...
to freeze
  ...
  ; Its will tag NotIts By? asking one of the NotIts here to set their tagged? to true
...
to run-away
  ...
  ; NotIts will turn away from the Its in its radius and run away from them at their speed. Otherwise they will wiggle the NotIts way

  ifelse any? its in-radius radius-of-runners
  [ face min-one-of its [ distance myself ]
    rt 180
    fd speed-of-runners
    rt random 361 - 180 ]
