...
Stamina is also the same. Large Max Stamina means it takes longer for them to drain their stamina, but it also means it takes them longer to stay in a resting period before turning back to normal. The same applies the other way around, lower stamina means that they drain their energy faster, but they recover to an amount that allows them to return to normal again faster too.
