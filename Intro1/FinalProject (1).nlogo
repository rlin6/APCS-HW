...
to setup
  ...
  if TagMode = "FreezeTag" [
    ...
    ask n-of ( Number-of-Its + Number-of-NotIts ) patches [
      let x ( count Its )
      ifelse x < Number-of-Its [
      sprout-Its 1 [
        set color red ] ]
    [ sprout-NotIts 1 [
        set color blue
...
to chase
  ...
  ifelse any? NotIts in-radius radius-of-Its [
...
to wiggleIt
  ...
  ; Its will wiggle at half the speed
...
to run-away
  ...
  ifelse any? its in-radius Radius-of-NotIts
...
to wiggle-NI
  ...
  ;NotIts will wiggle at half their speed

  fd ( speed-of-NotIts / 2 )
  rt random 361 - 180
end
